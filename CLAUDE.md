...
Security vulnerability detection skill for AI agents and IDEs. 565 checkpoints across 15 languages, 26 frameworks, 3 cloud providers, 4 CMS platforms, 2 mobile SDKs, plus GraphQL API, Kubernetes manifest and GitHub Actions workflow scanning, with compliance mapping to 7 frameworks.
...
- `test_eval_fixtures.py` — regex fixture tests (552 tests)
